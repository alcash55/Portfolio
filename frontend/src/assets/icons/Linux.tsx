...
/**
 * Tux, in his actual colours -- black and white body, orange beak and feet --
 * rather than the flat single-colour silhouette this used to render.
 *
 * The silhouette came from simple-icons, whose whole set is monochrome by
 * design; the real logo is a shaded, multi-colour drawing that one path cannot
 * express. This is the vectorised Tux from the `logos` icon set (originally
 * Larry Ewing's image, `lewing@isc.tamu.edu`, created with GIMP), which keeps
 * the gradients and still reads at the chip's 16px -- verified against the
 * flat version at 16, 18 and 48px on both light and dark chips.
 *
 * Unlike every other mark here it carries its own colours, so it neither takes
 * nor needs `currentColor`: a penguin is the same penguin on all six themes.
 *
 * The gradient and filter ids are prefixed `tux-` because ids are
 * document-global -- unprefixed, a second instance of this icon on the page
 * would collide with the first.
 */
const Linux = (props: SvgIconProps) => {
  const svg = (
    <svg viewBox="0 0 256 295" xmlns="http://www.w3.org/2000/svg">
      <title>Linux Logo</title>
      <defs>
        <linearGradient id="tux-SVGPY0tCbOa" x1="48.548%" x2="51.047%" y1="115.276%" y2="41.364%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVGZrQemdEu" x1="54.407%" x2="46.175%" y1="2.404%" y2="90.542%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".8" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGViD9UWNq" x1="51.86%" x2="47.947%" y1="88.248%" y2="9.748%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVGpwAGebry" x1="49.925%" x2="49.924%" y1="85.49%" y2="13.811%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVGeLJpbd6T" x1="53.901%" x2="45.956%" y1="3.102%" y2="93.895%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGoqBSHerK" x1="45.593%" x2="54.811%" y1="5.475%" y2="93.524%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVG4QSySb4K" x1="49.984%" x2="49.984%" y1="89.845%" y2="40.632%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVGmqOHmezj" x1="53.505%" x2="42.746%" y1="99.975%" y2="23.545%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVG6COJqcYh" x1="49.841%" x2="50.241%" y1="13.229%" y2="94.673%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".8" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGMM2cICtb" x1="49.927%" x2="50.727%" y1="37.327%" y2="92.782%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGGYYiOcHn" x1="49.876%" x2="49.876%" y1="2.299%" y2="81.204%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGWdyw0crI" x1="49.833%" x2="49.824%" y1="2.272%" y2="71.799%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVG83oHF3vg" x1="53.467%" x2="38.949%" y1="48.921%" y2="98.1%">
          <stop offset="0%" stopColor="#ffa63f" />
          <stop offset="100%" stopColor="#ff0" />
        </linearGradient>
        <linearGradient id="tux-SVGLpQcUdBQ" x1="52.373%" x2="47.579%" y1="143.009%" y2="-64.622%">
          <stop offset="0%" stopColor="#ffeed7" />
          <stop offset="100%" stopColor="#bdbfc2" />
        </linearGradient>
        <linearGradient id="tux-SVGehok0c3p" x1="30.581%" x2="65.887%" y1="34.024%" y2="89.175%">
          <stop offset="0%" stopColor="#ffa63f" />
          <stop offset="100%" stopColor="#ff0" />
        </linearGradient>
        <linearGradient id="tux-SVGSLPsocSe" x1="59.572%" x2="48.361%" y1="-17.216%" y2="66.118%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGr4fuKdTl" x1="47.769%" x2="51.373%" y1="1.565%" y2="104.313%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGOxCzIbUA" x1="43.55%" x2="57.114%" y1="4.533%" y2="92.827%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="tux-SVGp3HnSbuR" x1="49.733%" x2="50.558%" y1="17.609%" y2="99.385%">
          <stop offset="0%" stopColor="#ffa63f" />
          <stop offset="100%" stopColor="#ff0" />
        </linearGradient>
        <linearGradient id="tux-SVGSUrnubkU" x1="50.17%" x2="49.68%" y1="2.89%" y2="94.17%">
          <stop offset="0%" stopColor="#fff" stopOpacity=".65" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </linearGradient>
        <filter
