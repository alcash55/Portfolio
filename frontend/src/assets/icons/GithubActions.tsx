...
// GitHub Actions' brand blue (#2088FF) -- the mark is the workflow-graph
// glyph (nodes joined by connectors), not a wordmark, so the chip keeps its
// text label. Mid-tone and saturated like MUI's #007FFF, so it reads on
// light's near-white background and on all five dark ones without a swap.
const GithubActions = (props: SvgIconProps) => {
  const svg = (
