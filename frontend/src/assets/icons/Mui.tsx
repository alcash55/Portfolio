...
// MUI's brand blue (#007FFF, "Only Blue") -- mid-tone and saturated, so it
// holds up on light's near-white background as well as the five dark ones
// without a per-theme swap (same call the project already made for
// Typescript's #3178C6).
const Mui = (props: SvgIconProps) => {
  const svg = (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <title>MUI Logo</title>
      <path
        fill="#007FFF"
