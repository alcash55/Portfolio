...
// Supabase's brand green (#3FCF8E) -- mid-tone and saturated enough to read
// on light's near-white background and on all five dark backgrounds without
// a per-theme swap.
const Supabase = (props: SvgIconProps) => {
  const svg = (
