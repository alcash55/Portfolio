...
// Couchbase's brand red (#EA2328) -- mid-tone and saturated enough to read
// on light's near-white background and on all five dark backgrounds
// (including the red theme's near-black #2a0d0d, which is dark enough that
// sharing a hue family with the mark isn't a contrast problem) without a
// per-theme swap.
const Couchbase = (props: SvgIconProps) => {
  const svg = (
